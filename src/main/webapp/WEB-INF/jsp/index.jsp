                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="p-20">
                                    ...
                                    <div class="text-left">
                                        <h4 class="m-b-10">新手考核项目:绩效考核和会议室预约系统</h4>
                                        ...
                                        <p style="text-indent: 2rem;">
                                            <ol>
                                                ...
                                                <li>
                                                    <b style="color:red;">被考核人员从项目启动日开始，需要每周提交项目进度的周报（见附件新人考核项目周报模板.xls）</b>，汇报本周的工作内容和项目进度。周报发送给考核人负责人，同时需要抄送给部门总监肖欢（xiaoh@pvc123.com） 和考核负责人陈钊炬（chenzj@pvc123.com)。
                                                </li>
                                            </ol>
                                        </p>
                                        <p class="m-b-5">
                                            另外，此次考核项目要严格按照 《Java开发手册》 <a href="http://docs.r9it.com/manual/java/">http://docs.r9it.com/manual/java/</a> 的规范去进行开发。
                                        </p>
                                        <p class="m-b-5">
                                            本次考核负责人：凤雏（陈钊炬），qq：394001323
                                        </p>
                                    </div>
                                </div>
                            </div>
