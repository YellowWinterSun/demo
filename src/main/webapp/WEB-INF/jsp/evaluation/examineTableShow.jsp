        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <textarea rows="15" maxlength="225" class="form-control maxLenthTextarea"></textarea>
                        </div>
                    </div>
                </div>
    ...
    <div id="dy_editGradeModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">自评分输入框</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
...
<div class="container">
    ...
    <c:choose>
        ...
        <c:when test="${requestScope.doIt == false}">
            <input type="hidden" style="display:none;" id="templateId" value="${requestScope.template.id}"/>
            <!-- 模块Begin -->
            <div class="row" >
                    ...
                    <table>
                        <tr>
                            <td colspan="9" class="topLine">
                                ...
                                <div  class="topTitle">${requestScope.template.name}&nbsp;&nbsp;${requestScope.year}年&nbsp;${requestScope.month}&nbsp;月份绩效考核表</div>
                            </td>
                        </tr>
                        <tr class="text-left fontFat">
                            ...
                            <td colspan="4">姓名 : ${requestScope.template.userName}</td>
                        </tr>
                    </table>
                    <!-- 头部无边框部分表格 End-->
                    <!-- 主体table Begin-->
                    <table border="2px" bordercolor="0x4C96FF" align = "center">
                        ...
                        <c:forEach items="${requestScope.items}" var="item" varStatus="status">
                            ...
                            <tr>
                                ...
                                <td class="dy_editTd" tdName="selfContent" itemId='<c:out value="${item.id}"/>' ></td>
                                <td class="dy_editTd" tdName="selfGrade" itemId='<c:out value="${item.id}"/>' ></td>
                                <td></td>
                            </tr>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-right">
                    <div id="dy_toolbar" class="btn-group">
                        <button id="dy_checkBtn" title="审核内容是否有问题" type="button" class="btn btn-danger" disabled>
                            <i class="mdi mdi-table-edit" aria-hidden="true"></i> 审核填写内容
                        </button>
                        <button id="dy_submitBtn" title="提交" type="button" class="btn btn-primary">
                            <i class="mdi mdi-airplay" aria-hidden="true"></i> 提交绩效考核表
                        </button>
    ...
    <script src="/static/jsp_js/examineTableShow.js"></script>
</body>
</html>