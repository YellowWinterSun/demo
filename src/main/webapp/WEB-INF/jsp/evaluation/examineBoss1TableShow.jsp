...
<div class="container">
                    ...
                    <table border="2px" bordercolor="0x4C96FF" align = "center">
                        ...
                        <c:forEach items="${requestScope.items}" var="item" varStatus="status">
                            ...
                            <tr>
                                ...
                                <td class="dy_editTd" tdName="boss1Grade" itemId='<c:out value="${item.id}"/>'></td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td tdName="boss1Remark" class="dy_editTd" colspan="7" class="height80"></td>
                        </tr>
                        <tr>
    ...
    <script src="/static/jsp_js/examineBoss1TableShow.js"></script>
</body>
</html>